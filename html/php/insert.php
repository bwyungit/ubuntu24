...
//filename:./insert.php
   ...
   session_start();
    ...
    // 쿼리문 생성
   $insert_name="hong";
   $sql = "insert into user (name) values('$insert_name');";
   ...
   $connect = 
      mysqli_connect($mysql_hostname, $mysql_username, $mysql_password,$mysql_db);
  ...
  echo "</tr>";
   ...
   echo "</table>";
   $q = mysqli_close($connect);
   if( $q == "1" ){echo "<br>connection closed by 1. bye!<br>";};
   if( $q == "true" ){echo "<br>connection closed by true. bye!<br>";};
   echo $q;
?>
